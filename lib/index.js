export const ImagePath = {
  ...
  //직업 Job
  기계: require("/images/job/기계.jpg"),
  나이트: require("/images/job/나이트.jpg"),
  드루이드: require("/images/job/드루이드.jpg"),
  마법사: require("/images/job/마법사.jpg"),
  사냥꾼: require("/images/job/사냥꾼.jpg"),
  악마사냥꾼: require("/images/job/악마사냥꾼.jpg"),
  암살자: require("/images/job/암살자.jpg"),
  전사: require("/images/job/전사.jpg"),
  주술사: require("/images/job/주술사.jpg"),
  흑마법사: require("/images/job/흑마법사.jpg"),
}